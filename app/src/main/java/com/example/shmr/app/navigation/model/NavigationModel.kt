...
sealed class NavigationBottomModel(
    ...
    data object CheckNavigation : NavigationBottomModel("check",  R.drawable.ic_check_passive, "Счет")
    ...
    companion object {
        val navItems = listOf( ExpensesNavigation, IncomeNavigation, CheckNavigation , CategoriesNavigation , SettingsNavigation)
    }
}
