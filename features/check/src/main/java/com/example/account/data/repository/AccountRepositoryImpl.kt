...
import com.example.account.ui.mapper.toLocalAccount
...
class AccountRepositoryImpl @Inject constructor(
    ...
    override suspend fun getAccountById(id: Int): Result<AccountUi> {
        return try {
            ...
            if (localAccount != null) {
                Result.success(localAccount.toAccountUi())
            } else {
                ...
                if (refreshResult.isSuccess) {
                    ...
                    if (refreshedLocalAccount != null) {
                        Result.success(refreshedLocalAccount.toAccountUi())
                    } else {
    ...
    override suspend fun putAccountById(
        ...
        try {
            ...
            return Result.success(localAccountToUpdate.toAccountUi())
        } catch (e: Exception) {
